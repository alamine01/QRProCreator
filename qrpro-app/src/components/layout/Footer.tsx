        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4">
              Créez votre carte de visite numérique professionnelle avec QR code. 
              Partagez facilement vos informations de contact et réseaux sociaux.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/profile" className="text-gray-600 hover:text-primary-500 transition-colors">
                  Mon Profil
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600">contact@qrpro.com</span>
              </div>
              <div className="flex items-center space-x-3">
