      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mt-6 sm:mt-8 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl sm:rounded-3xl shadow-sm p-4 sm:p-6 lg:p-8 border border-purple-200/50">
          <div className="text-center">
            ...
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Commandez vos produits physiques QR Pro</h2>
            <p className="text-sm sm:text-base text-gray-600 mb-6 max-w-2xl mx-auto">Obtenez votre code QR imprimé sur des cartes NFC ou des autocollants de haute qualité. Paiement sécurisé par Mobile Money ou à la livraison.</p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                onClick={() => router.push('/dashboard/order-products')}
                className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 text-sm sm:text-base lg:text-lg"
              >
              ...
              >
                <Package className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 mr-2 sm:mr-3" />
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              <div className="bg-white/60 rounded-lg p-3">
                <div className="font-semibold text-gray-900">Carte NFC</div>
                <div className="text-primary-600 font-bold">20,000 FCFA</div>
              </div>
              <div className="bg-white/60 rounded-lg p-3">
                <div className="font-semibold text-gray-900">3 Autocollants</div>
                <div className="text-primary-600 font-bold">3,000 FCFA</div>
              </div>
              <div className="bg-white/60 rounded-lg p-3">
                <div className="font-semibold text-gray-900">Pack Complet</div>
                <div className="text-primary-600 font-bold">21,500 FCFA</div>
                <div className="text-xs text-green-600">Économisez 1,500 FCFA</div>
              </div>
            </div>
            
            <p className="text-xs sm:text-sm text-gray-500 mt-4">Paiement sécurisé par Orange Money, Wave ou à la livraison</p>
          </div>
        </div>
      </div>
