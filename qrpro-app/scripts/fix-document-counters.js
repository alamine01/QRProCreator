// Script pour corriger les compteurs des documents
const { initializeApp } = require('firebase/app');
const { getFirestore, collection, getDocs, doc, updateDoc, query, where } = require('firebase/firestore');

// Configuration Firebase (utiliser les vraies credentials)
...
async function fixDocumentCounters() {
  try {
    console.log('🔧 Correction des compteurs de documents...\n');
    ...
    console.log('\n✅ Tous les compteurs sont maintenant synchronisés !');
